...
unlocked to sign the Shirecoin-Qt.app bundle.
...
allowing somebody to distribute a Shirecoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the shirecoin-qt.exe file inside the installer had not been tampered with.
