...
{
    BOOST_CHECK(TestSplitHost("www.Shirecoin.io", "www.Shirecoin.io", -1));
    BOOST_CHECK(TestSplitHost("[www.Shirecoin.io]", "www.Shirecoin.io", -1));
    BOOST_CHECK(TestSplitHost("www.Shirecoin.io:80", "www.Shirecoin.io", 80));
    BOOST_CHECK(TestSplitHost("[www.Shirecoin.io]:80", "www.Shirecoin.io", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:35645", "127.0.0.1", 35645));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:35645", "127.0.0.1", 35645));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:35645", "::ffff:127.0.0.1", 35645));
    BOOST_CHECK(TestSplitHost("[::]:35645", "::", 35645));
    BOOST_CHECK(TestSplitHost("::35645", "::35645", -1));
    BOOST_CHECK(TestSplitHost(":35645", "", 35645));
    BOOST_CHECK(TestSplitHost("[]:35645", "", 35645));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:35645", "127.0.0.1:35645"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:35645", "[::]:35645"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
